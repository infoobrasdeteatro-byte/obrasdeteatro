...
export interface CreditReservation {
   ...
   * limite -- el plan es ilimitado --, no que se desconozca: es la ausencia
   * real de techo, representada explicitamente y no mediante una cifra
   * convenida (PRD-001). La columna admite null en la base desde la migracion
   * 20260831074722. Una reserva de un plan ilimitado se crea, se liquida y se
   * mide igual que cualquier otra; lo unico que no hace es poder denegarse.
   */
